...
namespace WebSite.Areas.Identity.Pages.Role
{
    ...
    {
        public AddRoleClaimModel(RoleManager<IdentityRole> roleManager, ILogger<RolePageModel> logger, IdentityStoreServices context) : base(roleManager, logger, context)
        {
        }
