...
namespace WebSite.Areas.Identity.Pages.Role
{
    ...
    {
        public DeleteRoleClaimModel(RoleManager<IdentityRole> roleManager, ILogger<RolePageModel> logger, IdentityStoreServices context) : base(roleManager, logger, context)
        {
        }
