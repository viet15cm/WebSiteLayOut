...
namespace WebSite.Areas.Identity.Pages.Role
{
    ...
    {
        public EditRoleClaimModel(RoleManager<IdentityRole> roleManager, ILogger<RolePageModel> logger, IdentityStoreServices context) : base(roleManager, logger, context)
        {
        }
