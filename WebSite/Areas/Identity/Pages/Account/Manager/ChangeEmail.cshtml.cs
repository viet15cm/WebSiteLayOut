...
{   
    public class ChangeEmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Không tồn tại người dùng có Id '{_userManager.GetUserId(User)}'.");
            }
            ...
            if (IsEmailConfirmed)
            {
                ...
                return  RedirectToPage("./ConfirmedChangeEmail");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    StatusMessage = "Email đả được thay đổi";
