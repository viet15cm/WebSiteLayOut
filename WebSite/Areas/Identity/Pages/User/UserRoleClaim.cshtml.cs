...
namespace WebSite.Areas.Identity.Pages.User
{
    ...
    {
        public UserRoleClaimModel(UserManager<AppUser> userManager, ILogger<UserPageModel> logger, IdentityStoreServices dbContext, RoleManager<IdentityRole> roleManager) : base(userManager, logger, dbContext, roleManager)
        {
